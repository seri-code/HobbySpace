...
<body class="is-preload" onload="init()">
    ...
    <header id="header">
        ...
        <a class="logo" href="/" /> <img src="resources/images/logo2.png" alt="logo Image" width="80" height="90" />
    ...
    <nav id="menu">
        <ul class="links">
            ...
            <li><a>
                    <div name="zzim" onClick="ToZzimList()" style="cursor: pointer">찜한 공간</div>
                </a></li>
            <li><a>
        ...
        <table class="type05">
            ...
            <tr>
                ...
                <td>
                    <div class="formtag">
                        <form action="#">
                            <textarea id="space_text" name="rvtext" placeholder="사용후기를 상세히 남겨주세요. 다른 회원에게 큰 도움이 됩니다:D" minlength="20" maxlength="500" required style="height: 108px;"></textarea>
                        </form>
                    </div>
                </td>
            </tr>
