	...
	<footer id="footer">
		<div class="inner">
			<div class="content">
				<section>
					<h3>&nbsp;HobbySpace</h3>
					&nbsp;상호명: 주식회사 하비스페이스 대표: 홍길동<br /> &nbsp;사업자등록번호: 123-45-67890 <br />
					&nbsp;통신판매업신고번호: 2021-서울강남-1234<br /> &nbsp;사업자등록정보 영업소재지: 인천광역시
					매소홀로 123<br /> &nbsp;이메일: null254@naver.com <br /> &nbsp;공간에 대한
					문의사항은 해당 공간 호스트에게 직접 문의해주세요.
				</section>
				<section>
