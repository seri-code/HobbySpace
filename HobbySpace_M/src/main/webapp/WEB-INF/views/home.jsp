...
<link
	href="https://fonts.googleapis.com/css2?family=Do+Hyeon&family=Poor+Story&display=swap"
	rel="stylesheet">
</head>
<body class="is-preload" onLoad="init();init2();init3();init4()">
	...
	<div class="slideshow-container">
		...
		<div class="mySlides fade">
			...
			<figure class="snip1200" onclick="spaceDetail()"
				style="cursor: pointer;">
				<img id="mainImage" class="bg-image" name="sp_topimg"
					style="width: 100%; height: 50rem; cursor: pointer;"
					onclick="spaceDetail()" />
				<figcaption>
					<p style="font-size: 30px">사진 클릭 시 공간 상세로 이동합니다.</p>
					<div class="heading">
						<h2>
							별점 최고<span> 추천공간</span>
						</h2>
					</div>
				</figcaption>
		...
		<div class="mySlides fade">
			...
			<figure class="snip1200" onclick="spaceDetail2()"
				style="cursor: pointer;">
				<img id="mainImage" class="bg-image" name="sp_topimg"
					style="width: 100%; height: 50rem; cursor: pointer;"
					onclick="spaceDetail2()" />
				<figcaption>
					<p style="font-size: 30px">사진 클릭 시 공간 상세로 이동합니다.</p>
					<div class="heading">
						<h2>
							예약 최다<span> 추천공간</span>
						</h2>
					</div>
				</figcaption>
		...
		<div class="mySlides fade">
			...
			<figure class="snip1200" onClick="spaceDetail3()"
				style="cursor: pointer;">
				<img id="mainImage" class="bg-image" name="sp_topimg"
					style="width: 100%; height: 50rem; cursor: pointer;"
					onclick="spaceDetail3()" />
				<figcaption>
					<p style="font-size: 30px">사진 클릭 시 공간 상세로 이동합니다.</p>
					<div class="heading">
						<h2>
							찜 클릭 수 최다<span> 추천공간</span>
						</h2>
					</div>
				</figcaption>
	...
	<section class="wrapper">
		<div class="inner">
			<div class="highlights">
				<section>
					<div class="content"
						onMouseOver="this.style.backgroundColor='#FFAA28';"
						onMouseOut="this.style.backgroundColor='#FFFFFF'"
						onclick="searchCate0()" style="cursor: pointer;">
						<header>
							<div class="image">
								<input type="image" name="cate" value="04"
									src="resources/images/Soccer.jpg" width="150" height="150">
							</div>
							<h3>운동</h3>
						</header>
						...
						<header>
							<div class="image">
								<input type="image" name="cate" value="06"
									src="resources/images/photo.jpg" width="150" height="150">
							</div>
							<h3>사진 스튜디오</h3>
						</header>
						...
						<header>
							<div class="image">
								<input type="image" name="cate" value="07"
									src="resources/images/cooking.jpg" width="150" height="150">
						...
						<header>
							<div class="image">
								<input type="image" name="cate" value="01"
									src="resources/images/drink.jpg" width="150" height="150">
							</div>
							<h3>주조</h3>
						</header>
						...
						<header>
							<div class="image">
								<input type="image" name="cate" value="08"
									src="resources/images/sing.jpg" width="150" height="150">
							</div>
							<h3>녹음실</h3>
						</header>
						...
						<header>
							<div class="image">
								<input type="image" name="cate" value="05"
									src="resources/images/tree.jpg" width="150" height="150">
							</div>
							<h3>목공</h3>
						</header>
			...
			<div class="testimonials">
				<section>
					<figure class="snip1141"
						onClick="reviewToSpace(loadReview[0].spCode)"
						style="cursor: pointer;">
				...
				<section>
					<figure class="snip1141"
						onClick="reviewToSpace(loadReview[1].spCode)"
						style="cursor: pointer;">
				...
				<section>
					<figure class="snip1141"
						onClick="reviewToSpace(loadReview[2].spCode)"
						style="cursor: pointer;">
						<div class="image" id="rv_img3"></div>
						<div class="content">
							<blockquote>
							...
							<div class="author">
								...
								<h2>Click</h2>
								<strong id="p"><span id="rv_star3"
									class="star-prototype"></span></strong> <span id="span3"></span>
								</p>
