...
<body class="is-preload" onLoad="init()">
	...
	<section class="wrapper" id="wrapper">
		<div class="inner">
			<h2 style="color: #FF5E00; font-family: 'paybooc-Bold';">예약리스트</h2>
...
<script>
	function init() {
		...
		for (i = 0; i < reserv1.length; i++) {
			...
			div1.style.borderBottom = "4px solid #ffa07a";
			div1.style.borderTop = "4px solid #ffa07a";
			div1.style.borderRight = "4px solid #ffa07a";
			div1.style.borderLeft = "4px solid #ffa07a";
			...
			div4.addEventListener("click", function() {
				Cancel(rospcode, rdcode, frdusedateTest, ronum)
			});
			div4.style.backgroundColor = '#ecdbc7';
			div4.style.fontColor = '#000000';
			div4.style.position = "relative";
			div4.style.width = "8.18rem";
			div4.style.borderBottom = "2px solid #ffa07a";
			div4.style.borderTop = "2px solid #ffa07a";
			div4.style.borderRight = "2px solid #ffa07a";
			div4.style.borderLeft = "2px solid #ffa07a";
			...
			div3.style.borderBottom = "2px solid #ffa07a";
			div3.style.borderTop = "2px solid #ffa07a";
			div3.style.borderRight = "2px solid #ffa07a";
			div3.style.borderLeft = "2px solid #ffa07a";
	...
	function Cancel(rospcode, rdcode, frdusedateTest, ronum) {
		...
		request.send("sCode=10" + "&rdcode=" + rdcode + "&rospcode=" + rospcode
				+ "&frdusedate=" + frdusedate + "&ronum=" + ronum);
	}
	function reserv() {
		//요소를 지움 즉 에이작스 init을 지운다
		$("#Sdiv").empty();
		...
		request.onreadystatechange = function() {
			if (this.readyState == 4 && this.status == 200) {
				...
				for (i = 0; i < reserv3.length; i++) {
					...
					if (reserv3[i].frdstatus == "N") {
						div7.textContent = "예약상태 : " + "승인거절";
					}
