...
<body class="is-preload" onLoad="init()">
	...
	<div>
		...
		<img class=img2 src="/resources/images/${getSptopimg13}"
			style="position: relative; left: 28%; margin-top: 74px;">
	</div>


	<!-- One -->
	<input onClick="Zzim()" type="button" value="리뷰를남겨주세요!"
		style="position: relative; background-color: moccasin; left: 40%;" />
	<div class="inner" id="inner">
		<div id="content" class="content" style="top: 280%; margin-top: 20px">
			<header class="align-center" id="align-center">
				<h2 id="h2" style="color: #000000;">예약 정보</h2>
...
<script>
	function Zzim() {
		...
		form.action = "ToNewReview?rdCode=" + rdcode + "&rdRoom=" + rdronum
				+ "&rdSpCode=" + frdrocode;
		form.method = "post";
