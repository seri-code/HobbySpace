...
<body class="is-preload" onLoad="init()">
	...
	<section class="wrapper" id="wrapper">
		<div class="inner">
			<h2 style="color: #FF5E00; font-family: 'paybooc-Bold';">공간관리</h2>
			<div class="highlights" id=Sdiv></div>
		</div>
	</section>

	<div class="button1">
		<button onClick="toInputSpace()"
			style="position: relative; background-color: darksalmon; width: 13rem; height: 6rem; font-size: 2rem; border: 4px solid; margin-bottom: 80px;">공간등록</button>
	</div>
