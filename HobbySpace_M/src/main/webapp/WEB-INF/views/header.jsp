...
<body class="is-preload">
	...
	<!-- Header -->
	<header id="header"
		style="height: 7.25rem; line-height: 7.25rem; background-color: cornsilk;">
		...
		<div class="search" style="position: absolute; top: 14px; right: 18%;">
			<input type="text" name="keyword" placeholder="검색어를 입력해주세요."
				...
				style="position: relative; top: 17px; width: 25rem; background-color: floralwhite;" />
			<button onClick="search()"
				style="position: absolute; top: 30%; right: 0%; background-color: gold;">검색</button>
		</div>

		<!-- 		<input id="indate" name="seDate" type="date" style="font-weight: 600; width: 10rem;"> -->
		<input type="text" id="text-calendar4" placeholder="날짜입력"
			class="calendar" style="font-weight: 600; width: 10rem;" /> <select
			id="sectlect" name="ctCode">
		...
		</select> <select id="select" name="spLocation">
		...
		<div id="option">
			...
			<input type="text" name="maxPeople" class="opt" value="0"
				placeholder="인원수"
				style="position: absolute; top: 40px; width: auto; height: 48px;" />
			<input type="button" value="+" class="opt" onClick="change(1)"
				style="position: relative; top: -10px; left: 128px;" /> <input
				type="button" value="-" class="opt" onClick="change(-1)"
				style="position: relative; top: -10px; left: 129px;" />
		</div>
...
<script>
	...
	function search() {
		...
		var sedate = document.getElementById("text-calendar4").value;
