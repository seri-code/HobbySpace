...
<script type="text/javascript"
	src="//dapi.kakao.com/v2/maps/sdk.js?appkey=95f3ade2f6c73e95d12d2e3bf84274b7&libraries=services"></script>
<link rel="stylesheet"
	...
	<nav id="menu">
		<ul class="links">
			...
			<li><a><div name="zzim" onClick="ToZzimList()"
						style="cursor: pointer; color: #696969; font-size: 15px;">찜한
						공간</div></a></li>
		...
		<div id="sidebar">
			<ul>
				<li>
					...
					<p>마음에 드는 공간을 찜 해보세요.</p> <br />
				<br />
				<br />
					<div class="wrap">
						<a onClick="zzim()" class="button">찜 하기♡</a> <a
							onClick="deleteZzim()" class="button">찜 삭제 :'(</a>
					</div>
				...
				<br />
					<ul>
						<li>
							...
							<div id="date1"></div>
							<div class="calendar"
								style="position: relative; width: 27rem; right: 66%; top: 4px;"></div>
							<div id="res"></div>
					</ul></li>
				<li>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="content">
					<div class="post">
						<h2 class="title"
							style="font-family: 'ELAND_Choice_M'; margin-top: 120px;">
							<a id="sp_name"></a>
						</h2>
...
function dated(now) {
		...
		while ( Sdiv1.hasChildNodes() ) { Sdiv1.removeChild( Sdiv1.firstChild ); }
