...
<jsp:include page="header.jsp"></jsp:include>
	...
	<div class="spaceinput" style="border:3px solid lightsalmon; margin-left: 15%; margin-right: 15%;">
	<div style="font-size: x-large; font-weight: 1000; position:relative; left:22rem;">공간명*</div>
	<div class="input"><input type="text" id="space_name" name="sp_name" required="" minlength="1" maxlength="20" style="border:2px solid; position:relative; left:20rem;" ></div>
	

	<div id="divct" style="font-size: x-large; font-weight: 1000; position:relative; left:29%;">카테고리*</div>

	<div style="font-size: x-large; font-weight: 1000; position:relative; left:29.5%;">공간한줄소개*</div>
	<div>
		<input type="text" id="space_intro" name="sp_intro" placeholder="공간을 소개하는 한줄 문장을 입력해주세요." minlength="1" maxlength="27" required="" value="" style="border:2px solid; position:relative; width:625px; left:28.5%;">
	</div>

	<div style="font-size: x-large; font-weight: 1000; position:relative; left:29.5%;">공간긴줄소개*</div>
	<div>
		<textarea id="space_text" name="sp_text" placeholder="공간을 상세하게 소개해보세요. 공간의 특징이나 주변환경 등의 세부정보를 작성하시면 효과적입니다." minlength="20" maxlength="500" required="" style="height: 200px; border:2px solid; width:625px; position: relative; left:28.5%;" ></textarea>
	</div>

	<div style="font-size: x-large; font-weight: 1000; position:relative; left:29.5%;">공간주의사항*</div>
	<div>
		<input type="text" name="sp_caution" id="space_rsv_caution" placeholder="주의사항을 작성해주세요." maxlength="100" value="" style="border:2px solid; width:625px; position:relative; left:28.5%;">
		<button onclick="add_sp_caution()" style="border:2px solid; position:relative; font-size:medium; width: 5rem; left:30%;">추가</button>
	</div>
	<div id="add_caution" style="position:relative; left:29.5%"></div>

	<div style="font-size: x-large; font-weight: 1000; position:relative; left:29.5%;">공간주소*</div>
	<div class="input" style="position:relative; left:28.5%;">
	...
	<div>
		<input type="text" id="sample6_detailAddress" placeholder="상세주소" style="border:2px solid; width:625px; position:relative; left:28.5%;">
	</div>
	
	<div style="font-size: x-large; font-weight: 1000; position:relative; left:29.5%;">공간Room 설정*</div>
	<div class="room" style="position: relative; left: 30%;">
		<input type="text" name="sp_room" maxlength="4" placeholder="방 번호" style="border:2px solid; width:625px;"><input type="text" name="sp_peopel" maxlength="3" placeholder="방의 최대 수용수" style="width:625px; "><input type="button" class="btnAdd" value="추가" style="border:2px solid; font-size:medium; width: 5rem; "><br>
	</div>
	
	
	<div style="font-size: x-large; font-weight: 1000; position:relative; left:29.5%">공간가격*</div>
	<div class="input">
		<input type="text" name="sp_price" id="space_price" placeholder="가격을 입력해 주세요." maxlength="30" value="" style="border:2px solid; position:relative; left:30%; width:625px;">
	</div>

		<div style="font-size: x-large; font-weight: 1000; position:relative; left:29.5%;">공간대표이미지*</div>
	<div class="inner inner_img" style="position:relative; left:29%;">대표이미지 파일을 추가해 주세요. (JPG, JPEG, PNG)</div>
	<div class="btn_box">
	
		<div class="uploadDiv" style="position: relative; left:35%;">
			<input type="file" name="uploadFile">
			<button id='uploadBtn' style="border:2px solid;">업로드</button>
		</div>
		
		<div class ="uploadResult">
		<ul id = "ulChildren" style="position:relative; left:29.5%;">
	...
	<div style="font-size: x-large; font-weight: 1000; position:relative; left:29.5%;">공간이미지*</div>
	<div class="inner inner_img2" style="position:relative; left:27%;">이미지 파일을 추가해 주세요. (JPG, JPEG, PNG)</div>
	<div class="btn_box2">
	
		<div class="uploadDiv2" style="position: relative; left:35%;">
			<input type="file" name="uploadFile2">
			<button id='uploadBtn2' style="border:2px solid;">업로드</button>
		</div>
		
		<div class ="uploadResult2">
		<ul id = "ulChildren2" style="position:relative; left:29.5%;">
	...
	<div style="font-size: x-large; font-weight: 1000; position:relative; left:29.5%">공간연락처*</div>
	<div class="input"><input type="text" name="sp_mobile" id="space_mobile" required="" minlength="1" maxlength="20" value="" style="border:2px solid; position: relative; width:625px; left:32%"></div>

	<div style="font-size: x-large; font-weight: 1000; position:relative; left:29.5%">공간SNS*</div>
	<div class="input"><input type="text" name="sp_sns" id="space_url" placeholder="웹사이트 URL을 입력해주세요." value="" style="border:2px solid; position: relative; width:625px; left:32%;">
		<button onclick="add_sp_sns()" style="border:2px solid; position:relative; font-size:medium; width: 5rem; left:32%;">추가</button>
	</div>
	<div id="add_sns" style="position:relative; left:29.5%;"></div>

	<div style="font-size: x-large; font-weight: 1000; position:relative; left:29.5%">공간태그*</div>
	<div class="input"><input type="text" name="sp_tag" id="space_tag" placeholder="태그를 입력해 주세요." maxlength="30" value="" style="border:2px solid; position: relative; width:625px; left:32%;">
		<button onclick="add_sp_tag()" style="border:2px solid; position:relative; font-size:medium; width: 5rem; left:32%;">추가</button>
	</div>
	<div id="add_tag" style="position:relative; left:29.5%"></div>
	</div>
	<br>
	<button onclick="toDate()" style="border:3px solid; position: relative; width: 7rem; height: 5rem; font-size: 175%; left:50%; background-color:lightsalmon;">다음</button>
